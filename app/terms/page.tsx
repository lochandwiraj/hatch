...
export const metadata = { title: 'Terms & Conditions — HATCH' }
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <Section title="5. Payments">
            <p>All payments are processed in INR via Razorpay. By making a payment, you agree to Razorpay's terms of service. HATCH does not store your payment credentials. All prices are inclusive of applicable taxes where required.</p>
          </Section>
